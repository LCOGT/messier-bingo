/*!
	...
	(c) Stuart Lowe/LCOGT
*/
(function(){var a=function(g,f,e){if(typeof(e)=="string"){e=f.path(e).attr({stroke:"none","text-anchor":"middle"})}for(var b=0;b<g.length;b++){var d=g[b];var c=e.getPointAtLength(d.getBBox().x);f.transformer(d,["T",(c.x-d.getBBox().x),(c.y-d.getBBox().y-d.getBBox().height),"R",(c.alpha<360?180+c.alpha:c.alpha)])}};Raphael.fn.transformer=function(c,b){return c.transform(b).data("transform",b)};Raphael.fn.print_center=function(g,f,d,c,k,b){var j=this.print(g,f,d,c,k,"baseline",b);var e=j.getBBox();var i=(g-e.x)-e.width/2;var h=(f-e.y)-e.height/2;return this.transformer(j,["t",(-e.width/2),(e.height/2)])};Raphael.fn.printLetters=function(h,e,m,d,l,g){d=d||m/1.5;l=l||m;this.setStart();var b=0,j=0;for(var f=0;f<h.length;f++){if(h.charAt(f)!="\n"){var c=this.print(b,j,h.charAt(f),e,m);b+=d}else{b=0;j+=l}}var k=this.setFinish();if(g){a(k,this,g)}return k}})();(function($){
/*@cc_on
